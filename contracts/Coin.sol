...
contract Testing is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdCE53C2950624985483318342e1EE95A19005Cd1); 
    address payable public Wallet_Dev = payable(0xdCE53C2950624985483318342e1EE95A19005Cd1);
    address payable public constant Wallet_Burn = payable(0xdCE53C2950624985483318342e1EE95A19005Cd1); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =900000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "Korea Coin"; 
    string private constant _symbol = unicode"KRK"; 
    ...
    constructor () {
        _owner = 0xdCE53C2950624985483318342e1EE95A19005Cd1;
